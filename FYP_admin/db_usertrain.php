...
if (isset($_POST['trainStart']) && isset($_POST['trainEnd'])) {
    ...
    $query = "SELECT * FROM user_train WHERE train_date BETWEEN '{$tstart}' AND '{$tend}' ORDER BY train_date ASC";
    ...
    if ($total_data > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <tr>
                <th scope="row">'.$cnt++.'</th>
                <td>'.$row['image_id'].'</td>
                <td class="text-success font-weight-bold">'.$row['real_gender'].'</td>
                <td class="text-success font-weight-bold">'.$row['real_age'].'</td>
                <td class="text-info font-weight-bold">'.$row['predict_gender'].'</td>
                <td class="text-info font-weight-bold">'.$row['predict_age'].'</td>
